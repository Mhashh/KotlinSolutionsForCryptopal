...
fun main(){
    ...
    for (pt in plaintexts){
        ...
        ciphers[i] = aesCtr(Global2.key,nonce,bytes)
        i++
    }

    val keystream = breakXorTranspose(ciphers)
    println("Decrypted ---------------------------------------->")
...
fun breakXorTranspose(ciphers:Array<ByteArray>):ByteArray{
...
fun frequencyScoree(msg:String):Double{
